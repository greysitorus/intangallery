...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <button class="btn btn-dropdown dropdown-toggle" type="button" data-toggle="dropdown">Hello, <?php echo $fullname ?>  <span class="caret"></span></button>
    ...
    <!-- DataTables JS -->
    <script src="js/bakkor.js"></script>
